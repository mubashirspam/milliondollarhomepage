    ...
    try {
      if (mode === "signup") {
        ...
        if (error) {
          ...
          addToast("Account created! You're now signed in.", "success");
          closeModal();
        }
      } else {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md p-6 m-4">
        ...
        <button
          onClick={() =>
            authClient.signIn.social({ provider: "google", callbackURL: "/buy" })
          }
          className="w-full py-3 bg-white border border-gray-300 text-gray-700 rounded-lg font-bold hover:bg-gray-50 transition flex items-center justify-center gap-3 mb-4"
        >
